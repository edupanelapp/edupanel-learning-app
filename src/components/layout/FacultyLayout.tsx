...
export function FacultyLayout() {
  ...
  const navigation = [
    ...
    { name: "Projects", href: "/faculty/projects", icon: Rocket },
    { name: "Students", href: "/faculty/students", icon: Users },
    { name: "Approvals", href: "/faculty/approvals", icon: UserCheck },
  ]
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/faculty/dashboard" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-primary hidden sm:block">EduPanel Faculty</span>
            </Link>
